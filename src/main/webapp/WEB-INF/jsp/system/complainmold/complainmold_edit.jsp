...
<body>
	<form action="complainmold/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="COMPLAINMOLD_ID" id="COMPLAINMOLD_ID" value="${pd.COMPLAINMOLD_ID}"/>
		<div id="zhongxin">
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">抱怨类型:</td>
				<td><input type="text" name="COMPLAINNAME" id="COMPLAINNAME" value="${pd.COMPLAINNAME}" maxlength="32" placeholder="这里输入抱怨类型" title="抱怨类型"/></td>
			</tr>
			<tr>
			...
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">删除标识 默认0:</td>
				<td><input type="text" name="DELETED" id="DELETED" value="${pd.DELETED}" maxlength="32" placeholder="这里输入删除标识 默认0" title="删除标识 默认0"/></td>
			</tr>
			<tr>
