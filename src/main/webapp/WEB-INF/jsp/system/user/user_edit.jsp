	...
	<form action="user/${msg }.do" name="userForm" id="userForm" method="post">
		...
		<table>
			...
			<%-- <tr class="info">
				<td>
					<!-- 公司 -->
					<select class="chzn-select" name="COMPANY_ID" id="COMPANY_ID" data-placeholder="请选择公司" style="vertical-align:top;">
					<option value=""></option>
					<c:forEach items="${companyList}" var="company">
						<option value="${company.COMPANY_ID}" <c:if test="${company.COMPANY_ID == pd.COMPANY_ID }">selected</c:if>>${company.COMPANY_NAME }</option>
					</c:forEach>
					</select>
				</td>
			</tr> --%>
			...
			<tr class="info">
				<td>
					<!-- 部门 -->
					<select class="chzn-select" name="DEPARTMENT_ID" id="DEPARTMENT_ID" data-placeholder="请选择部门" style="vertical-align:top;">
					<option value=""></option>
					<c:forEach items="${departmentList}" var="department">
						<option value="${department.DEPARTMENT_ID}" <c:if test="${department.DEPARTMENT_ID == pd.DEPARTMENT_ID }">selected</c:if>>${department.DEPARTMENT_NAME }</option>
					</c:forEach>
					</select>
				</td>
			</tr>
