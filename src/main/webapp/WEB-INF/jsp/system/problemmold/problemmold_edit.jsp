...
<body>
	<form action="problemmold/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="PROBLEMMOLD_ID" id="PROBLEMMOLD_ID" value="${pd.PROBLEMMOLD_ID}"/>
		<div id="zhongxin">
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">问题分类名:</td>
				<td><input type="text" name="MOLDNAME" id="MOLDNAME" value="${pd.MOLDNAME}" maxlength="32" placeholder="这里输入问题分类名" title="问题分类名"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="DELETED" id="DELETED" value="${pd.DELETED}" maxlength="32" placeholder="这里输入是否删除" title="是否删除"/></td>
			</tr>
			<tr>
