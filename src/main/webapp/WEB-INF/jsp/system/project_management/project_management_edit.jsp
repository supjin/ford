...
<body>
	<form action="project_management/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="PROJECT_MANAGEMENT_ID" id="PROJECT_MANAGEMENT_ID" value="${pd.PROJECT_MANAGEMENT_ID}"/>
		<div id="zhongxin">
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				...
				<td><input type="number" name="DELETED" id="DELETED" value="${pd.DELETED}" maxlength="32" placeholder="这里输入删除标识" title="删除标识"/></td>
			</tr>
			<tr>
