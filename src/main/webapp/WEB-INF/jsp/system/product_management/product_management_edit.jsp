...
<body>
	<form action="product_management/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="PRODUCT_MANAGEMENT_ID" id="PRODUCT_MANAGEMENT_ID" value="${pd.PRODUCT_MANAGEMENT_ID}"/>
		<div id="zhongxin">
