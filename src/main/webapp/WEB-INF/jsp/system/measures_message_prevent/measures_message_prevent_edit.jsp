...
<body>
	<form action="measures_message_prevent/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="MEASURES_MESSAGE_PREVENT_ID" id="MEASURES_MESSAGE_PREVENT_ID" value="${pd.MEASURES_MESSAGE_PREVENT_ID}"/>
