...
<body>
	<form action="client_management/${msg }.do" name="Form" id="Form" method="post">
		<input type="hidden" name="CLIENT_MANAGEMENT_ID" id="CLIENT_MANAGEMENT_ID" value="${pd.CLIENT_MANAGEMENT_ID}"/>
		<div id="zhongxin">
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">删除标识0默认1删除:</td>
				<td><input type="text" name="DELATED" id="DELATED" value="${pd.DELATED}" maxlength="32" placeholder="这里输入删除标识0默认1删除" title="删除标识0默认1删除"/></td>
			</tr>
			<tr>
