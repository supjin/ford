package com.ft.controller.system.attachment;
...
public class AttachmentController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		try{
			...
			mv.setViewName("system/attachment/attachment_list");
	...
	public ModelAndView goAdd() throws Exception{
		logBefore(logger, "去新增Attachment页面");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		try {
			mv.setViewName("system/attachment/attachment_edit");
	...
	public ModelAndView goEdit() throws Exception{
		logBefore(logger, "去修改Attachment页面");
		ModelAndView mv = this.getModelAndView();
		PageData pd = new PageData();
		pd = this.getPageData();
		try {
	...
	public Object deleteAll() throws Exception {
		logBefore(logger, "批量删除Attachment");
	...
	public ModelAndView exportExcel() throws Exception{
		logBefore(logger, "导出Attachment到excel");
		...
		try{
			...
			for(int i=0;i<varOList.size();i++){
				...
				vpd.put("var3", varOList.get(i).getString("ATTACHMENT_NAME"));	//3
				vpd.put("var4", varOList.get(i).getString("ATTACHMENT_URL"));	//4
