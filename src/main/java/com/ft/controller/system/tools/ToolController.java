package com.ft.controller.system.tools;
...
import com.ft.util.MapDistance;
import com.ft.util.PageData;
import com.ft.util.PathUtil;
import com.ft.util.TwoDimensionCode;
...
public class ToolController extends BaseController {
	...
	@ResponseBody
	public Object readTwoDimensionCode() throws Exception{
		Map<String,String> map = new HashMap<String,String>();
		PageData pd = new PageData();
		pd = this.getPageData();
