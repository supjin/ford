package com.ft.service.system.role;
...
public class RoleService{
	...
	//列出部门 
	public List<PageData> listAllRolesGrouD(PageData pd) throws Exception {
		return (List<PageData>) dao.findForList("RoleMapper.listAllRolesGrouD", pd);
	}
	//列出子部门 
	public List<PageData> listAllRolesGrouS(PageData pd) throws Exception {
		return (List<PageData>) dao.findForList("RoleMapper.listAllRolesGrouS", pd);
	}
	//删除K权限表里对应的数据
