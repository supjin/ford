		...
		if(totalResult>0){
			...
			if(currentPage==1){
				if(flag ==1){
					...
					sb.append("	<li><input type=\"number\" value=\"\" id=\"toGoPage\" style=\"width:50px;text-align:center;float:left;display:none\" placeholder=\"页码\"/></li>\n");
					sb.append("	<li style=\"cursor:pointer;display:none\"><a onclick=\"toTZ();\"  class=\"btn btn-mini btn-success\">跳转</a></li>\n");
